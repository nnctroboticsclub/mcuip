...
export class App {
  ...
  public controls: Controls = {
    num: {
      ...
      "msl": { prev: NaN, curr: 1, range: [0, 2] },
      "msr": { prev: NaN, curr: 1, range: [0, 2] },
      ...
      "urep": { prev: NaN, curr: 1, range: [0, 1] },
      "urei": { prev: NaN, curr: 0, range: [0, 1] },
      "ured": { prev: NaN, curr: 0, range: [0, 1] },
      "uls": { prev: NaN, curr: 0, range: [0, 1] },
      "urf": { prev: NaN, curr: 0, range: [0, 1] },
      "uef": { prev: NaN, curr: 0, range: [0, 1] },
    },
    bool: {
  ...
  public packet_types: PacketType[] = [
    ...
    { id: 0x05, type: "bool", subtype: "button", target: ["urc"], counter: 0 },
    ...
    { id: 0x06, type: "num", subtype: "pid", target: ["urep", "urei", "ured"], counter: 0 },
    ...
    { id: 0x06, type: "num", subtype: "value", target: ["msl"], counter: 0 },
    { id: 0x07, type: "num", subtype: "value", target: ["msr"], counter: 0 },
    { id: 0x08, type: "num", subtype: "value", target: ["urf"], counter: 0 },
    { id: 0x09, type: "num", subtype: "value", target: ["uef"], counter: 0 },
  ];
